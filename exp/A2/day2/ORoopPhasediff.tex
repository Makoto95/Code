...
\node[gp node right] at (10.479,8.047) {'ORoopk.txt' using 1:3};
...
\gpcolor{color=gp lt color border}
\node[gp node right] at (10.479,7.739) {'ORoopksmall.txt' using 1:3};
...
\gpcolor{color=gp lt color border}
\node[gp node right] at (10.479,7.431) {'ORoopkbig.txt' using 1:3};
